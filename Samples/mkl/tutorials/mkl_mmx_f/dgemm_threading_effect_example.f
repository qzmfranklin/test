...
C*******************************************************************************
      ...
      INTEGER          I, J, L, M, K, N, R, LOOP_COUNT, MAX_THREADS
...
C     computer to make sure that total run time is at least 1 second
      PARAMETER        (M=2000, K=200, N=1000, LOOP_COUNT=10)
...
10    FORMAT(a,I5,a,I5,a,I5,a,I5,a)
 ...
 60     FORMAT(A,I2,A)
      ...
      L=(S_ELAPSED*LOOP_COUNT)+1;
      PRINT *, "It is highly recommended to parameter LOOP_COUNT for"
        PRINT *, "this example on your computer as ",L," to have total "
